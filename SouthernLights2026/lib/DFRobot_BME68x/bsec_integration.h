...
/* Use the following bme68x driver: https://github.com/BoschSensortec/BME68x_driver/releases/tag/bme68x_v3.5.1 */
#include "bme68x.h"
...
typedef struct{
  int8_t bme68x_status;              /**< Result of API execution status */
 ...
 */
return_values_init bsec_iot_init(float sample_rate, float temperature_offset, bme68x_com_fptr_t bus_write, bme68x_com_fptr_t bus_read, 
    sleep_fct sleep, uint8_t addr, enum bme68x_intf intf);
